...
import { ArrowLeft, Loader2, Phone, MapPin, Home, FileText, Truck, Euro, Store, Building, Hash, Map as MapIcon, AlertCircle, User, Mail, Save, Trash2 } from 'lucide-react';
...
const CheckoutForm = () => {
  ...
  // Handler pre zapamätanie údajov
  ...
  // Handler pre zabudnutie uložených údajov
      ...
      <div className="p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            <h4 className="text-lg font-semibold text-[#4a5d23] border-b border-[#e0e8c9] pb-2">
              Kontaktné údaje
            </h4>
            ...
            <FormField
              ...
              helpText="Pre zaslanie potvrdenia objednávky"
            />
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            {/* Checkbox pre zapamätanie údajov */}
            <div className="border-t border-neutral-200 pt-4 mt-6">
              <label className="flex items-center space-x-3 cursor-pointer">
                ...
                <div className="flex items-center space-x-2">
                  <Save className="w-4 h-4 text-[#4a5d23]" />
              ...
              <p className="text-xs text-neutral-500 mt-1 ml-7">
                Vaše kontaktné údaje budú uložené v prehliadači pre rýchlejšie objednávanie
              </p>
            </div>
          </div>
        </form>
