...
import { Plus, Loader2, Pizza as PizzaIconLucide, AlertCircle } from 'lucide-react';
...
// Fallback obrázok
const FALLBACK_IMAGE = '/images/pizzas/placeholder.jpg';
      ...
      >
        ...
        >
          <div className="relative overflow-hidden rounded-t-lg" style={{ paddingBottom: '60%' }}>
            {/* SVG ikona pizze namiesto obrázka */}
            <div className="absolute inset-0 bg-gradient-to-br from-amber-50 to-orange-50 flex items-center justify-center">
              <PizzaIcon pizzaName={name} size={80} className="transition-transform duration-500" />
            </div>
